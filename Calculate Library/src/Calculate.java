...
public class Calculate {
	...
	//returns the average of the value passed
	...
	//provides the coefficients of a quadratic equation in standard form (a, b, and c) and returns the value of the discriminant
	...
	//converts mixed number (with its pieces provided separately in the whole number, numerator, then denominator) into an improper fraction
	...
	//converts an improper fraction (with its pieces provided separately in the order numerator then denominator)into a mixed number
	...
	//converts a binomial multiplication of the form (ax + b)(cx+d) into quadratic equation of the form ax^2 + bx + c, accepts a four integers and a String and then returns a String.
	...
	//determines whether or not one integer is evenly divisible by another, accepts two integers and returns a boolean.
	...
	//returns the absolute value of the number passed, method accepts a double and returns a double.
	...
	//returns the larger of the values passed, accepts two doubles and returns a double.
	...
	//returns the smaller of the values passed, accepts two integers and returns an int.
	...
	//raises a value to a positive integer power, accepts a double and an integer and returns a double
	...
	//returns the factorial of the value passed, accepts an integer and returns an integer
	...
	//returns an approximation of the square root, accepts a double and returns a double, rounds to hundredth place
